...
// const ctaContent = document.querySelector('img');
// const 
...
const topContent = document.querySelector('.top-content h4');
const topTextContent = document.querySelector('.top-content p');
